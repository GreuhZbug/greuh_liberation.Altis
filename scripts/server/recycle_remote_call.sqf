...
_objectinfo = ( [ (light_vehicles + heavy_vehicles + air_vehicles + static_vehicles + support_vehicles), { typeof _object_recycled == _x select 0 } ] call BIS_fnc_conditionalSelect ) select 0;
