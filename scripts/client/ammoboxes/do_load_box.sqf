...
_maxload = 3;
_neartransporttrucks = [ ((getpos player) nearEntities [ ammobox_transports_typenames, 15]), { alive _x && speed _x < 5 && ((getpos _x) select 2) < 5 } ] call BIS_fnc_conditionalSelect;
