...
opfor_squad_8_paratroop = [opfor_squad_leader,opfor_paratrooper,opfor_machinegunner,opfor_paratrooper,opfor_medic,opfor_marksman,opfor_paratrooper,opfor_rpg];
